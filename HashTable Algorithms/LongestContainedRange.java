...
public class LongestContainedRange {
	...
	private static int findLongestContainedRangeInt(List<Integer> A) {
		...
		Map.Entry<Integer, Integer> m = Collections.max(L.entrySet(), new Comparator<Map.Entry<Integer, Integer>>() {
			@Override
	...
	private static int longestRangeLen(int a, Set<Integer> S, Map<Integer, Integer> L) {
